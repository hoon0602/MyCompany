    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_callcenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(Intent.ACTION_DIAL, Uri.parse("tel:080-1111-2222"));
        ...
        btn_mail.setOnClickListener(new View.OnClickListener() {
            ...
            if (edit_name.length()<1){
                ...
                Toast.makeText(CallActivity.this, "개인정보 취급방침에 동의해주세요",Toast.LENGTH_SHORT).show();
                chk_agree.requestFocus();
            }else{
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setData(Uri.parse("smsto:010-1111-222"));
